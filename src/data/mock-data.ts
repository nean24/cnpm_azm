...
export interface Movie {
  ...
  aiHint: string; // Added for specific AI hints for Unsplash search
}
...
export const mockMovies: Movie[] = [
  {
    ...
    posterUrl: 'https://picsum.photos/seed/dune_planet_arrakis/400/600',
    ...
    status: 'now_showing',
    aiHint: 'SciFi Adventure',
  },
  {
    id: '2', // Godzilla x Kong: The New Empire
    title: 'Godzilla x Kong: Đế Chế Mới',
    posterUrl: 'https://picsum.photos/seed/monster_titans_clash/400/600',
    ...
    status: 'now_showing',
    aiHint: 'Monster Action',
  },
  {
    id: '3', // Kung Fu Panda 4
    title: 'Kung Fu Panda 4',
    posterUrl: 'https://picsum.photos/seed/panda_warrior_animated/400/600',
    ...
    status: 'now_showing',
    aiHint: 'Animation Comedy',
  },
  {
    id: '4', // Furiosa: A Mad Max Saga
    title: 'Furiosa: Câu Chuyện Từ Max Điên',
    posterUrl: 'https://picsum.photos/seed/furiosa_wasteland_journey/400/600',
    ...
    status: 'now_showing',
    aiHint: 'Action Wasteland',
  },
  {
    id: '5', // Kingdom of the Planet of the Apes
    title: 'Hành Tinh Khỉ: Vương Quốc Mới',
    posterUrl: 'https://picsum.photos/seed/apes_legacy_reign/400/600',
  ...
  },
  {
    ...
    posterUrl: 'https://picsum.photos/seed/emotions_inside_teen/400/600',
    ...
    status: 'now_showing',
    aiHint: 'Animation Emotion',
  },
  {
    id: '7', // Despicable Me 4
    title: 'Kẻ Trộm Mặt Trăng 4',
    posterUrl: 'https://picsum.photos/seed/minions_supervillain_family/400/600',
  ...
  {
    id: '8', // The Garfield Movie
    title: 'The Garfield Movie',
    posterUrl: 'https://picsum.photos/seed/lazy_cat_adventure/400/600',
  ...
  {
    id: '9', // A Quiet Place: Day One
    title: 'Vùng Đất Câm Lặng: Ngày Một',
    posterUrl: 'https://picsum.photos/seed/silent_world_aliens/400/600',
    ...
    status: 'coming_soon',
    aiHint: 'Horror Silence',
  },
  {
    id: '10', // Deadpool & Wolverine
    title: 'Deadpool & Wolverine',
    posterUrl: 'https://picsum.photos/seed/heroes_teamup_comic/400/600',
  ...
  {
    id: '11', // Wicked Part One
    title: 'Wicked: Phần Một',
    posterUrl: 'https://picsum.photos/seed/oz_witch_story/400/600',
    ...
    rating: 'P',
    language: 'Phụ đề',
    durationMinutes: 150, // Placeholder
  ...
  },
  {
    id: '12', // Moana 2
    title: 'Moana 2',
    posterUrl: 'https://picsum.photos/seed/ocean_voyage_legend/400/600',
    ...
    rating: 'P',
    language: 'Lồng tiếng',
    durationMinutes: 100, // Placeholder
    releaseDate: '2024-11-27',
    status: 'coming_soon',
...
export const mockShowtimes: Showtime[] = [
  ...
  { id: 'st1', movieId: '1', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-02-15', startTime: '18:00', format: '3D' },
  { id: 'st2', movieId: '1', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-02-15', startTime: '21:30', format: '2D' },
  { id: 'st3', movieId: '1', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-02-16', startTime: '20:00', format: '3D' },
  // Godzilla x Kong: Đế Chế Mới (2)
  { id: 'st4', movieId: '2', cinemaId: 'cinema1', hallId: 'hallB', date: '2025-02-18', startTime: '19:00', format: '2D' },
  { id: 'st5', movieId: '2', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-02-19', startTime: '17:00', format: '2D' },
  // Kung Fu Panda 4 (3)
  { id: 'st6', movieId: '3', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-02-20', startTime: '16:00', format: '2D' },
  { id: 'st7', movieId: '3', cinemaId: 'cinema1', hallId: 'hallB', date: '2025-02-21', startTime: '14:00', format: '3D' },
  // Furiosa: Câu Chuyện Từ Max Điên (4) 
  { id: 'st8', movieId: '4', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-03-08', startTime: '19:30', format: '2D' },
  { id: 'st9', movieId: '4', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-03-09', startTime: '18:30', format: '3D' },
  // Hành Tinh Khỉ: Vương Quốc Mới (5)
  { id: 'st10', movieId: '5', cinemaId: 'cinema1', hallId: 'hallB', date: '2025-03-01', startTime: '15:00', format: '3D' },
  { id: 'st11', movieId: '5', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-03-02', startTime: '17:30', format: '2D' },
  // Những Mảnh Ghép Cảm Xúc 2 (6) 
  { id: 'st12', movieId: '6', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-03-15', startTime: '20:15', format: '2D' },
  { id: 'st13', movieId: '6', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-03-16', startTime: '19:00', format: '3D' },
  // Kẻ Trộm Mặt Trăng 4 (7)
  { id: 'st14', movieId: '7', cinemaId: 'cinema1', hallId: 'hallB', date: '2025-02-25', startTime: '22:00', format: '2D' },
  { id: 'st15', movieId: '7', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-02-26', startTime: '21:00', format: '2D' },
  // The Garfield Movie (8)
  { id: 'st16', movieId: '8', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-02-10', startTime: '14:30', format: '2D' },
  { id: 'st17', movieId: '8', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-02-11', startTime: '16:30', format: '2D' },

  // Coming Soon Movies for late March (or earlier if they get early access in the mock)
  // Vùng Đất Câm Lặng: Ngày Một (9) 
  { id: 'st18', movieId: '9', cinemaId: 'cinema1', hallId: 'hallB', date: '2025-03-22', startTime: '18:00', format: '2D' },
  // Deadpool & Wolverine (10)
  { id: 'st19', movieId: '10', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-03-29', startTime: '19:45', format: '3D' },
  // Wicked: Phần Một (11)
  { id: 'st20', movieId: '11', cinemaId: 'cinema1', hallId: 'hallA', date: '2025-03-15', startTime: '13:00', format: '2D' }, // Example early showing
  // Moana 2 (12) 
  { id: 'st21', movieId: '12', cinemaId: 'cinema2', hallId: 'hallVIP1', date: '2025-03-22', startTime: '17:00', format: '3D' }, // Example early showing
];
